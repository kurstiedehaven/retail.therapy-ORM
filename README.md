...
This was a project where we had to build the back end for an e-commerce site. We were provided with starter code. We worked with Express.js API and configured it to use Sequelize to interact with our MYSQL database.
